...
vaccineTweets = search_tweets("moderna OR pfizer OR vaccine OR Johnson and Johnson",
                       n=200000, include_rts=FALSE,
                       token=twitter_token, 
                       geocode="37,-94,1000mi",
                       retryonratelimit=TRUE) 

#saveRDS(vaccineTweets, "procedure/code/vaccineTweets.rds")
#saveRDS(threeRivers, "procedure/code/threeRivers.rds")
