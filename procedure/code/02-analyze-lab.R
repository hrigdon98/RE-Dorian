...
counties = filter(counties,
                  ...
                  # %in% c('54', '51', '50', '47', '45', '44', '42', '39',
                  #                '37','36', '34', '33', '29', '28', '25', '24',
                  #                '23', '22', '21', '20','18', '17','13', '12', '11',
                  #                '10', '09', '05', '01', '02', '04','06' ,'08','06','15','16','19', '26', '27',
                  #                 '30', '31', '32', '35', '38', '39', '40', '41', '46', '48', '49', '53', '55', '56') )
...
ggplot() +
  ...
  labs(title = "Tweet Locations About Vaccinations")+
